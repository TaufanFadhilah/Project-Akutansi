        <aside class="side-navigation-wrap sidebar-fixed">  <!-- START: Side Navigation -->
            <div class="sidenav-inner">
                ...
                <ul class="side-nav magic-nav">
                    ...
                    <li>
                        <a href="index.php"><i class="sli-dashboard"></i> <span class="nav-text">Dashboard</span></a>
                    </li>
                    ...
                    <li class="has-submenu">
                        ...
                        <div class="sub-menu collapse secondary" id="submenuTwo">
                            <ul>
                                ...
                                <li><a href="ui-tree-view.php">Tree View</a></li>
                                <li><a href="ui-modals.php">Models</a></li>
                                <li><a href="ui-alerts.php">Alerts</a></li>
                                <li><a href="ui-sliders.php">Sliders</a></li>
                    ...
                    <li class="has-submenu">
                        ...
                        <div class="sub-menu collapse secondary" id="submenuThree">
                            <ul>
                                <li><a href="form-basic.php">Basic</a></li>
                                <li><a href="form-advanced.php">Advanced Controls</a></li>
