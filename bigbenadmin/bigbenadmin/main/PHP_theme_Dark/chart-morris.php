...
<head>
    <meta charset="utf-8">
    <title>Morris Chart | Big Ben Admin</title>
    ...
    <link rel="stylesheet" type="text/css" media="all"  href="assets/plugins/morris/morris.css" />
...
<body>
    ...
    <script type="text/javascript" src="assets/js/chart-morris.js"></script>
    <script>
