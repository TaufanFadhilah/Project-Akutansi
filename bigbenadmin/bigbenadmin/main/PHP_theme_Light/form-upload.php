...
<head>
    <meta charset="utf-8">
    <title>Form Upload | Big Ben Admin</title>
    ...
    <link rel="stylesheet" type="text/css" media="all"  href="assets/plugins/dropzone/dropzone.css" />
...
<body>
    ...
    <div class="wrapper has-footer">
        ...
        <div class="main-container">    <!-- START: Main Container -->
            ...
            <div class="page-header">
                <h1>Form Upload <small>Dropzone file uploader</small></h1>
                <ol class="breadcrumb">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <h3 class="panel-title">Dropzone.js Upload</h3>
                                <div class="tools">
    ...
    <script type="text/javascript" src="assets/js/page-forms.js"></script>
